  ...
  export const MeditComent = ({ onClose,isOpen }: ModalProps) =>{
          ...
          <div className='bg-[#ECEDBC] w-[45%] h-[45%]  rounded-2xl p-6 flex flex-col'>
              ...
              <div >
                ...
                <div className='flex space-x-4'>
                      ...
                      <button className=' bg-[#050036] px-6 py-2   text-sm text-white rounded-xl cursor-pointer hover:scale-110 duration-200'>     
